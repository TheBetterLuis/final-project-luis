              ...
              <form className="flex max-w-md flex-col gap-4 ">
                  ...
                  <>
                    <div>
                      ...
                      <h2 className="drop-shadow-md text-center text-white text-lg py-2">
                        ...
                        verificación. Este código nos permitirá confirmar que
                        eres tú y así poder proceder con el cambio de tu clave.
                ...
                {isFinished && (
                  <>
                    <div className="mb-2 block ">
                      <h2 className="drop-shadow-md text-center text-white text-lg py-2">
                        Tu clave ha sido cambiada con exito, puedes proceder a
                        iniciar sesion con tu nueva clave.
                      </h2>
                    </div>
                    <Button
                      className="bg-azul2 drop-shadow-md "
